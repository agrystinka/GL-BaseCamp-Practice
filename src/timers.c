...
void pwm_timer_tim2_setup(){
	...
	mgl_mode_setup(mgl_led_blue, GPIO_MODE_AF, GPIO_PUPD_NONE);
	mgl_mode_setup(mgl_led_green, GPIO_MODE_AF, GPIO_PUPD_NONE);
	mgl_mode_setup(mgl_led_orange, GPIO_MODE_AF, GPIO_PUPD_NONE);

	timer_enable_oc_preload(TIM2, TIM_OC1 | TIM_OC2 | TIM_OC2);
